...
public class EditTextHelper {
    ...
    public static char[] getEditTextChars(final EditText text, final boolean removeSpaces) {
    ...
    public static boolean areEditTextsEqual(final EditText text1, final EditText text2) {
