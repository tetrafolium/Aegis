...
public class TextDrawableHelper {
  ...
  private static ColorGenerator _generator = ColorGenerator.create(
      Arrays.asList(0xFFD32F2F, 0xFFC2185B, 0xFF7B1FA2, 0xFF512DA8, 0xFF303F9F,
  ...
  public static TextDrawable generate(final String text, final String fallback,
                                      final View view) {
