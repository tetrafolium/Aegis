...
public class HotpInfo extends OtpInfo {
  ...
  public HotpInfo(final byte[] secret, final long counter)
  ...
  public HotpInfo(final byte[] secret, final String algorithm, final int digits,
                  final long counter) throws OtpInfoException {
  ...
  public String getOtp() {
    try {
      OTP otp = HOTP.generateOTP(getSecret(), getAlgorithm(true), getDigits(),
                                 getCounter());
      return otp.toString();
