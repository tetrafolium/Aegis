...
public class DatabaseFile {
  ...
  public boolean isEncrypted() { return !_header.isEmpty(); }
  ...
  public static DatabaseFile fromJson(final JSONObject obj)
  ...
  public static DatabaseFile fromBytes(final byte[] data)
      throws DatabaseFileException {
    try {
  ...
  public JSONObject getContent() { return (JSONObject)_content; }

  public JSONObject getContent(final DatabaseFileCredentials creds)
      throws DatabaseFileException {
    try {
  ...
  public void setContent(final JSONObject obj,
                         final DatabaseFileCredentials creds)
      throws DatabaseFileException {
    try {
      String string = obj.toString(4);
  ...
  public static class Header {
    ...
    public static Header fromJson(final JSONObject obj)
        throws DatabaseFileException {
      ...
      try {
        ...
        CryptParameters params =
            CryptParameters.fromJson(obj.getJSONObject("params"));
    ...
    public boolean isEmpty() { return _slots == null && _params == null; }
  }
}
