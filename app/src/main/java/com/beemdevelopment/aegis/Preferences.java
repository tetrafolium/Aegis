...
public class Preferences {
  ...
  public void setCurrentSortCategory(final SortCategory category) {
    _prefs.edit()
        .putInt("pref_current_sort_category", category.ordinal())
        .apply();
  }

  public SortCategory getCurrentSortCategory() {
    return SortCategory.fromInteger(
        _prefs.getInt("pref_current_sort_category", 0));
  }
  ...
  public int getTimeout() { return _prefs.getInt("pref_timeout", -1); }
