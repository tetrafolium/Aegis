...
public class Base32 {
  ...
  private static final int[] base32Lookup = {
      0xFF, 0xFF, 0x1A, 0x1B,
      0x1C, 0x1D, 0x1E, 0x1F, // '0', '1', '2', '3', '4', '5', '6', '7'
      0xFF, 0xFF, 0xFF, 0xFF,
      0xFF, 0xFF, 0xFF, 0xFF, // '8', '9', ':', ';', '<', '=', '>', '?'
      0xFF, 0x00, 0x01, 0x02,
      0x03, 0x04, 0x05, 0x06, // '@', 'A', 'B', 'C', 'D', 'E', 'F', 'G'
      0x07, 0x08, 0x09, 0x0A,
      0x0B, 0x0C, 0x0D, 0x0E, // 'H', 'I', 'J', 'K', 'L', 'M', 'N', 'O'
      0x0F, 0x10, 0x11, 0x12,
      0x13, 0x14, 0x15, 0x16, // 'P', 'Q', 'R', 'S', 'T', 'U', 'V', 'W'
      0x17, 0x18, 0x19, 0xFF,
      0xFF, 0xFF, 0xFF, 0xFF, // 'X', 'Y', 'Z', '[', '\', ']', '^', '_'
      0xFF, 0x00, 0x01, 0x02,
      0x03, 0x04, 0x05, 0x06, // '`', 'a', 'b', 'c', 'd', 'e', 'f', 'g'
      0x07, 0x08, 0x09, 0x0A,
      0x0B, 0x0C, 0x0D, 0x0E, // 'h', 'i', 'j', 'k', 'l', 'm', 'n', 'o'
  ...
  public static byte[] decode(final char[] base32) throws Base32Exception {
    ...
    for (i = 0, index = 0, offset = 0; i < base32.length; i++) {
      ...
      if (base32[i] == '=') {
        // make sure the rest is also padding, but don't bother verifying the
        // length
  ...
  private static int decodeDigit(final int c) throws Base32Exception {
