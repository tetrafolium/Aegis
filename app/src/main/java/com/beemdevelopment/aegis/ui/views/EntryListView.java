...
public class EntryListView extends Fragment implements EntryAdapter.Listener {
  ...
  public View onCreateView(final LayoutInflater inflater,
    ...
    View view =
        inflater.inflate(R.layout.fragment_entry_list_view, container, false);
    ...
    RecyclerViewPreloader<DatabaseEntry> preloader =
        new RecyclerViewPreloader<>(Glide.with(this), modelProvider,
                                    _preloadSizeProvider, 10);
    ...
    LayoutAnimationController animation =
        AnimationUtils.loadLayoutAnimation(getContext(), resId);
  ...
  public void setActionModeState(final boolean enabled,
                                 final DatabaseEntry entry) {
    _touchCallback.setSelectedEntry(entry);
    _touchCallback.setIsLongPressDragEnabled(enabled &&
                                             _adapter.isDragAndDropAllowed());
    _adapter.setSelectedEntry(entry);
  }

  public void setSortCategory(final SortCategory sortCategory,
                              final boolean apply) {
    _touchCallback.setIsLongPressDragEnabled(sortCategory ==
                                             SortCategory.CUSTOM);
  ...
  public void setListener(final Listener listener) { _listener = listener; }
  ...
  private void updateDividerDecoration() {
    ...
    if (_showProgress && height == 0) {
      ...
      divider.setDrawable(
          ContextCompat.getDrawable(getContext(), R.drawable.entry_divider));
  ...
  private class IconPreloadProvider
      implements ListPreloader.PreloadModelProvider<DatabaseEntry> {
    @NonNull
    @Override
    ...
    getPreloadRequestBuilder(final @NonNull DatabaseEntry entry) {
