...
public class PreferencesFragment extends PreferenceFragmentCompat {
  ...
  public void onCreatePreferences(final Bundle savedInstanceState,
    ...
    darkModePreference.setSummary(String.format(
        "%s: %s", getString(R.string.selected),
        getResources().getStringArray(R.array.theme_titles)[currentTheme]));
    darkModePreference.setOnPreferenceClickListener(
        new Preference.OnPreferenceClickListener() {
          ...
          public boolean onPreferenceClick(final Preference preference) {
            ...
            Dialogs.showSecureDialog(
                new AlertDialog.Builder(getActivity())
                    .setTitle(R.string.choose_theme)
                    .setSingleChoiceItems(
                        R.array.theme_titles, currentTheme,
                        (dialog, which) -> {
                          int i = ((AlertDialog)dialog)
                                      .getListView()
                                      .getCheckedItemPosition();
                          app.getPreferences().setCurrentTheme(
                              Theme.fromInteger(i));
    ...
    viewModePreference.setSummary(
        String.format("%s: %s", getString(R.string.selected),
                      getResources().getStringArray(
                          R.array.view_mode_titles)[currentViewMode]));
    viewModePreference.setOnPreferenceClickListener(
        new Preference.OnPreferenceClickListener() {
          @Override
          public boolean onPreferenceClick(final Preference preference) {
            int currentViewMode =
                app.getPreferences().getCurrentViewMode().ordinal();
                    ...
                    .setSingleChoiceItems(
                        ...
                        (dialog, which) -> {
                          int i = ((AlertDialog)dialog)
                                      .getListView()
                                      .getCheckedItemPosition();
                          app.getPreferences().setCurrentViewMode(
                              ViewMode.fromInteger(i));
                          viewModePreference.setSummary(String.format(
                              "%s: %s", getString(R.string.selected),
                              getResources().getStringArray(
                                  R.array.view_mode_titles)[i]));
    ...
    importAppPreference.setOnPreferenceClickListener(
        new Preference.OnPreferenceClickListener() {
          @Override
          public boolean onPreferenceClick(final Preference preference) {
            onImportApp();
    ...
    /*EditTextPreference timeoutPreference = (EditTextPreference)
    findPreference("pref_timeout");
    timeoutPreference.setOnPreferenceChangeListener(new
    Preference.OnPreferenceChangeListener() {
        @Override
        public boolean onPreferenceChange(Preference preference, Object
    newValue) {
            preference.setSummary(String.format(getString(R.string.pref_timeout_summary),
    (String) newValue)); return true;
        }
    });
    timeoutPreference.getOnPreferenceChangeListener().onPreferenceChange(timeoutPreference,
    timeoutPreference.getText());*/

    Preference issuerPreference = findPreference("pref_account_name");
    issuerPreference.setOnPreferenceChangeListener(
    ...
    Preference searchAccountNamePreference =
        findPreference("pref_search_names");
    searchAccountNamePreference.setOnPreferenceChangeListener(
        (preference, newValue) -> {
          _result.putExtra("needsRefresh", true);
          return true;
        });
    ...
    Preference entryHighlightPreference =
        findPreference("pref_highlight_entry");
    entryHighlightPreference.setOnPreferenceChangeListener(
        (preference, newValue) -> {
          _result.putExtra("needsRefresh", true);
          return true;
        });
    ...
    tapToRevealPreference.setOnPreferenceChangeListener(
        (preference, newValue) -> {
          _result.putExtra("needsRefresh", true);
          return true;
        });
    ...
    screenPreference.setOnPreferenceChangeListener(
        new Preference.OnPreferenceChangeListener() {
          @Override
          public boolean onPreferenceChange(final Preference preference,
                                            final Object newValue) {
    ...
    Preference tapToRevealTimePreference =
        findPreference("pref_tap_to_reveal_time");
    tapToRevealTimePreference.setSummary(
        app.getPreferences().getTapToRevealTime() + " seconds");
    tapToRevealTimePreference.setOnPreferenceClickListener(
        new Preference.OnPreferenceClickListener() {
          @Override
          public boolean onPreferenceClick(final Preference preference) {
            Dialogs.showNumberPickerDialog(
                getActivity(), new Dialogs.NumberInputListener() {
                  @Override
    ...
    _encryptionPreference.setOnPreferenceChangeListener(
        new Preference.OnPreferenceChangeListener() {
          @Override
          public boolean onPreferenceChange(final Preference preference,
                                            final Object newValue) {
            if (!_db.isEncryptionEnabled()) {
              Dialogs.showSetPasswordDialog(getActivity(),
                                            new EnableEncryptionListener());
            } else {
              Dialogs.showSecureDialog(
                  new AlertDialog.Builder(getActivity())
                      .setTitle(R.string.disable_encryption)
                      .setMessage(
                          getString(R.string.disable_encryption_description))
                      .setPositiveButton(
                          ...
                          new DialogInterface.OnClickListener() {
                            public void onClick(final DialogInterface dialog,
                              ...
                              try {
                                ...
                                Toast
                                    .makeText(getActivity(),
                                              R.string.disable_encryption_error,
                                              Toast.LENGTH_SHORT)
                                    .show();
                                return;
                              }
                              ...
                              getActivity().stopService(new Intent(
                                  getActivity(), NotificationService.class));
    ...
    _fingerprintPreference =
        (SwitchPreference)findPreference("pref_fingerprint");
    _fingerprintPreference.setOnPreferenceChangeListener(
        new Preference.OnPreferenceChangeListener() {
          @Override
          public boolean onPreferenceChange(final Preference preference,
                                            final Object newValue) {
            ...
            if (!slots.has(FingerprintSlot.class)) {
              if (FingerprintHelper.isSupported() &&
                  FingerprintHelper.isAvailable(getContext())) {
                Dialogs.showFingerprintDialog(
                    getActivity(), new RegisterFingerprintListener());
              }
            } else {
    ...
    _slotsPreference.setOnPreferenceClickListener(
        new Preference.OnPreferenceClickListener() {
          @Override
          public boolean onPreferenceClick(final Preference preference) {
            Intent intent =
                new Intent(getActivity(), SlotManagerActivity.class);
    ...
    _groupsPreference.setOnPreferenceClickListener(
        new Preference.OnPreferenceClickListener() {
          ...
          public boolean onPreferenceClick(final Preference preference) {
            Intent intent =
                new Intent(getActivity(), GroupManagerActivity.class);
  ...
  public void onRequestPermissionsResult(final int requestCode,
    ...
    if (!PermissionHelper.checkResults(grantResults)) {
      Toast
          .makeText(getActivity(), R.string.permission_denied,
                    Toast.LENGTH_SHORT)
          .show();
      return;
    }
  ...
  public Intent getResult() { return _result; }
  ...
  private void onImport() {
    if (!PermissionHelper.request(getActivity(), CODE_PERM_IMPORT,
                                  Manifest.permission.READ_EXTERNAL_STORAGE)) {
      return;
    }

    Map<String, Class<? extends DatabaseImporter>> importers =
        DatabaseImporter.getImporters();
  ...
  private void onImportApp() {
    Map<String, Class<? extends DatabaseImporter>> importers =
        DatabaseImporter.getAppImporters();
    String[] names = importers.keySet().toArray(new String[0]);
            ...
            .setPositiveButton(
                ...
                (dialog, which) -> {
                  int i = ((AlertDialog)dialog)
                              .getListView()
                              .getCheckedItemPosition();
                  Class<? extends DatabaseImporter> importerType =
                      Objects.requireNonNull(importers.get(names[i]));
                  DatabaseImporter importer =
                      DatabaseImporter.create(getContext(), importerType);
                  importApp(importer);
                })
            .create());
  }
  ...
  private void importApp(final DatabaseImporter importer) {
    ...
    try (Shell shell = Shell.getShell()) {
      if (!shell.isRoot()) {
        Toast.makeText(getActivity(), R.string.root_error, Toast.LENGTH_SHORT)
            .show();
        return;
      }
      ...
      try (SuFileInputStream stream = new SuFileInputStream(file)) {
        DatabaseImporter.FileReader reader =
            new DatabaseImporter.FileReader(stream, true);
        importDatabase(importer, reader);
      }
    } catch (PackageManager.NameNotFoundException e) {
      e.printStackTrace();
      Toast
          .makeText(getActivity(), R.string.app_lookup_error,
                    Toast.LENGTH_SHORT)
          .show();
    } catch (IOException | DatabaseImporterException e) {
      e.printStackTrace();
      Toast
          .makeText(getActivity(), R.string.reading_file_error,
                    Toast.LENGTH_SHORT)
          .show();
    }
  }

  private void importDatabase(final DatabaseImporter importer,
                              final DatabaseImporter.FileReader reader) {
    try {
      ...
      if (state.isEncrypted()) {
        ...
        if (state instanceof AegisImporter.EncryptedState) {
          ...
          intent.putExtra("slots",
                          ((AegisImporter.EncryptedState)state).getSlots());
          ...
          state.decrypt(getActivity(), new DatabaseImporter.DecryptListener() {
            ...
            public void onError(final Exception e) {
              Toast
                  .makeText(getActivity(), R.string.decryption_error,
                            Toast.LENGTH_SHORT)
                  .show();
            }
          });
      ...
      String msg = String.format(
          "%s: %s", getString(R.string.parsing_file_error), e.getMessage());
  ...
  private void onImportDecryptResult(final int resultCode, final Intent data) {
    ...
    DatabaseFileCredentials creds =
        (DatabaseFileCredentials)data.getSerializableExtra("creds");
  ...
  private void onImportResult(final int resultCode, final Intent data) {
    ...
    try (InputStream stream =
      ...
      DatabaseImporter importer =
          DatabaseImporter.create(getContext(), _importerType);
      DatabaseImporter.FileReader reader =
          new DatabaseImporter.FileReader(stream);
      importDatabase(importer, reader);
    } catch (FileNotFoundException e) {
      Toast.makeText(getActivity(), R.string.file_not_found, Toast.LENGTH_SHORT)
          .show();
    } catch (IOException e) {
      e.printStackTrace();
      Toast
  ...
  private void importDatabase(final DatabaseImporter.State state) {
    ...
    intent.putExtra(
        "errors",
        (ArrayList<DatabaseImporterEntryException>)result.getErrors());
    startActivityForResult(intent, CODE_SELECT_ENTRIES);
  }

  private void onExport() {
    if (!PermissionHelper.request(getActivity(), CODE_PERM_EXPORT,
            ...
            .setPositiveButton(
                ...
                (dialog, which) -> {
                  ...
                  try {
                    ...
                    Toast
                        .makeText(getActivity(),
                                  R.string.exporting_database_error,
                                  Toast.LENGTH_SHORT)
                        .show();
                    return;
                  }
                  ...
                  MediaScannerConnection.scanFile(
                      getActivity(), new String[] {filename}, null, null);

                  Toast
                      .makeText(getActivity(),
                                getString(R.string.export_database_location) +
                                    filename,
                                Toast.LENGTH_SHORT)
                      .show();
                })
  ...
  private void onGroupManagerResult(final int resultCode, final Intent data) {
    ...
    HashSet<String> groups =
        new HashSet<>(data.getStringArrayListExtra("groups"));
  ...
  private void onSelectEntriesResult(final int resultCode, final Intent data) {
    ...
    List<ImportEntry> selectedEntries =
        (ArrayList<ImportEntry>)data.getSerializableExtra("entries");
    for (ImportEntry selectedEntry : selectedEntries) {
      DatabaseEntry savedEntry =
          _importerEntries.getByUUID(selectedEntry.getUUID());
    ...
    String toastMessage = getResources().getString(
        R.string.imported_entries_count, selectedEntries.size());
  ...
  private boolean saveDatabase() {
    try {
      ...
      Toast.makeText(getActivity(), R.string.saving_error, Toast.LENGTH_LONG)
          .show();
      return false;
    }
  ...
  private void updateEncryptionPreferences() {
    ...
    if (encrypted) {
      ...
      boolean canUseFinger = FingerprintHelper.isSupported() &&
                             FingerprintHelper.isAvailable(getContext());
  ...
  private class SetPasswordListener implements Dialogs.SlotListener {
    ...
    public void onException(final Exception e) {
      ...
      Toast
          .makeText(getActivity(),
                    getString(R.string.encryption_set_password_error) +
                        e.getMessage(),
                    Toast.LENGTH_SHORT)
          .show();
    }
  ...
  private class RegisterFingerprintListener implements Dialogs.SlotListener {
    ...
    public void onException(final Exception e) {
      Toast
          .makeText(getActivity(),
                    getString(R.string.encryption_enable_fingerprint_error) +
                        e.getMessage(),
                    Toast.LENGTH_SHORT)
          .show();
    }
