...
public class CustomAuthenticationSlide extends Fragment
    implements ISlidePolicy, RadioGroup.OnCheckedChangeListener {
  ...
  public View onCreateView(final LayoutInflater inflater,
    ...
    final View view = inflater.inflate(R.layout.fragment_authentication_slide,
                                       container, false);
    ...
    // only enable the fingerprint option if the api version is new enough,
    // permission is granted and a scanner is found
  ...
  public void onUserIllegallyRequestedNextPage() {
    Snackbar snackbar = Snackbar.make(
        getView(), getString(R.string.snackbar_authentication_method),
