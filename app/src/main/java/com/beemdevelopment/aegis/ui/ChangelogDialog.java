  ...
  public Dialog onCreateDialog(final Bundle savedInstanceState) {
    ...
    try {
      customView = LayoutInflater.from(getActivity())
                       .inflate(R.layout.dialog_web_view, null);
    ...
    try (InputStream html = getActivity().getAssets().open("changelog.html")) {
      ...
      webView.loadData("<h1>Unable to load</h1><p>" + e.getLocalizedMessage() +
                           "</p>",
                       "text/html", "UTF-8");
    }
    return dialog;
