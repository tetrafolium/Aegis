...
public class EntryAdapter extends RecyclerView.Adapter<EntryHolder>
  ...
  public void setViewMode(final ViewMode viewMode) { _viewMode = viewMode; }
  ...
  private void checkPeriodUniformity() { checkPeriodUniformity(false); }
  ...
  public boolean isPeriodUniform() { return getUniformPeriod() != -1; }
