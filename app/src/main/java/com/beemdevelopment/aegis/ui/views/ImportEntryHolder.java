...
public class ImportEntryHolder
    extends RecyclerView.ViewHolder implements ImportEntry.Listener {
  ...
  public void setData(final ImportEntry entry) {
    ...
    _issuer.setText(!entry.getIssuer().isEmpty()
                        ? entry.getIssuer()
  ...
  public ImportEntry getEntry() { return _entry; }
