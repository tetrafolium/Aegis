...
public class DerivationTask
    extends ProgressDialogTask<DerivationTask.Params, SecretKey> {
  ...
  protected SecretKey doInBackground(final DerivationTask.Params... args) {
    ...
    SCryptParameters scryptParams = new SCryptParameters(
        ...
        CryptoUtils.CRYPTO_SCRYPT_p, salt);
  ...
  public static class Params {
    ...
    public PasswordSlot getSlot() { return _slot; }

    public char[] getPassword() { return _password; }
  }

  public interface Callback { void onTaskFinished(SecretKey key); }
}
