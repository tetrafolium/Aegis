...
public class ScannerActivity
    extends AegisActivity implements ZXingScannerView.ResultHandler {
  ...
  protected void onCreate(final Bundle state) {
    ...
    if (camera == -1) {
      ...
      if (camera == -1) {
        Toast
            .makeText(this, getString(R.string.no_cameras_available),
                      Toast.LENGTH_LONG)
            .show();
        finish();
      }
  ...
  public void handleResult(final Result rawResult) {
    try {
      ...
      Toast
          .makeText(this, getString(R.string.read_qr_error), Toast.LENGTH_SHORT)
          .show();
    }
